...
{
  PBKDF2 pbkdf2;
  pbkdf2.generate(masterPassword, salt, KGKIterations, QCryptographicHash::Sha256);
...
{
  PBKDF2 pbkdf2;
  pbkdf2.generate(masterPassword, salt, DomainIterations, QCryptographicHash::Sha384);
